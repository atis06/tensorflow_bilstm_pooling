...
with tf.Session() as sess:
    prev_epoch_loss = 0
    sess.run(init)
    if os.path.isfile('/srv/project/encoder/tensorflow_bilstm_pooling/masked_lm/model/mlm/1/mlm-model-epoch1.ckpt.index'):
        print('Restoring weights...')
        saver.restore(sess, '/srv/project/encoder/tensorflow_bilstm_pooling/masked_lm/model/mlm/1/mlm-model-epoch1.ckpt')
